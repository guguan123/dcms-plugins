...
if (isset($_GET['sell_all'])) {
    ...
    header("Location: /plugins/farm/sklad");
    exit;
}
...
if (isset($_GET['id'])) {
    ...
    if (isset($_GET['sell'])) {
        ...
        header('Location: /plugins/farm/sklad?sell_ok');
    }

    farm_event();

    echo "<div class='rowup'><center>";
    echo "<img src='/plugins/farm/bush/" . $post['semen'] . ".png' alt=''></center><br/> <b>种子 " . $semen['name'] . "</b><br/>";
